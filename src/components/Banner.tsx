...
export default function Banner() {
  return (
    <section className="relative z-30 lg:h-screen h-[80svh] w-screen flex items-center justify-center overflow-hidden bg-green">
      ...
      <Image src="/banner-1.jpg" alt="Teixeira Duarte" className="rounded-bl-[210px] object-cover" priority quality={100} fill />
      <div className="absolute inset-0 bg-black/60 rounded-bl-[210px]" />
