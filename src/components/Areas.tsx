      ...
      <div className="container">
        ...
        <div className="flex flex-col lg:flex-row lg:gap-20 gap-12 items-center justify-center">
          <div className="border border-orange p-10 rounded-[60px]">
            ...
            <p className="text-green font-light max-w-85 my-6">
            ...
            <Link href="/direito-trabalhista" className="font-bold py-2 px-3.5 rounded-full bg-orange text-white hover:bg-black/30 transition-all duration-300 cursor-pointer">
              Saiba mais
            </Link>
          </div>
